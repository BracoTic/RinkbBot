...
console.log("🔥 ESTE ES MI SERVER ACTUAL");
...
app.post("/api/login", async (req, res) => {
  try {
    console.log("✅ LOGIN body:", req.body); // <-- mira qué llega desde el frontend/powershell
    ...
    console.error("🔥 LOGIN error FULL:", e?.stack || e);
...
app.get("/", (req, res) => {
  res.send("RinkBot Backend OK ✅ Usa /api/settings o /api/login");
});
